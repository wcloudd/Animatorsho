...
import { PROFILE_MOBILE_VERIFY_OTP_COPY } from '@/lib/auth-form-data';
import { cn } from '@/lib/utils';
import { create } from '@/routes/profile/mobile';
import { resendCode } from '@/routes/profile/mobile';
import { store as verifyStore } from '@/routes/profile/mobile/verify';
...
export default function ProfileMobileVerify({
    maskedMobile,
    resendAvailableAt,
    status,
    message,
}: Props) {
    const copy = PROFILE_MOBILE_VERIFY_OTP_COPY;
                        ...
                        <>
                            <div className="grid gap-5">
                                ...
                                <Button
                                    ...
                                    tabIndex={2}
                                    disabled={processing}
                                    data-test="profile-mobile-verify-button"
                                >
                            ...
                            <div className="flex flex-col items-center gap-3 text-center">
                                {resendSeconds > 0 ? (
                                    ...
                                    <Button
                                        ...
                                        data-test="profile-mobile-resend-button"
                                    >
