...
function StatusBadge({
    ...
    return (
        <span
            className={cn(
                'inline-flex items-center rounded-pill px-2.5 py-1 text-[11px] font-bold ring-1',
                active
                    ? 'bg-green-soft text-green ring-green/20'
                    : 'bg-bg text-muted ring-border/70',
            )}
        >
            ...
            <div className="flex flex-col gap-5">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex min-w-0 flex-1 flex-col gap-2">
                        <span className="text-sm font-bold text-text">وضعیت حساب</span>
                        {maskedMobile ? (
                ...
                <p className="rounded-2xl bg-bg px-4 py-3 text-sm font-medium leading-relaxed text-muted ring-1 ring-border/60">
                    برای ورود جایگزین، ایمیل و رمز عبور تنظیم کنید.
                </p>
            </div>
        </article>
    );
