...
### ۴.۳ ویدیوی راهنمای نصب اسپات‌پلیر (صفحه پروفایل)

| نام فایل | مسیر کامل | وضعیت | نقش | نکات |
|---|---|---|---|---|
| `spotplayer-install-guide.mp4` | `public/videos/spotplayer-install-guide.mp4` | ❌ آپلود نشده | ویدیوی راهنمای نصب و فعال‌سازی اسپات‌پلیر — در صفحه پروفایل، بخش «دوره‌ها و دسترسی من»، دکمه «راهنمای نصب اسپات‌پلیر» | در مودال با `controls` پخش می‌شود — بدون autoplay — دارای صدا — فرمت: MP4 H.264، `-movflags +faststart` |

> **مسیر آپلود:** فایل را در `public/videos/spotplayer-install-guide.mp4` قرار دهید. پوشه `videos/` ممکن است هنوز وجود نداشته باشد؛ در صورت لزوم بسازید.

---

### ۴.۴ منابع آپلود‌شده توسط ادمین (dynamic)
